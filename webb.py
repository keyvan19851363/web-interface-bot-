...
require a bot token.
"""
TOKEN ='7418404305:AAFZtI8cUSWTs_PghbKZoAz6slgo7RRneQA'
import json
import logging
import telebot
#from telegram import KeyboardButton, ReplyKeyboardMarkup, ReplyKeyboardRemove, 
from telegram import Update, WebAppInfo , ReplyKeyboardMarkup , KeyboardButton , ReplyKeyboardRemove
    ...
    await update.message.reply_text(
        ...
        reply_markup=ReplyKeyboardMarkup.from_button(
            KeyboardButton(
                ...
                web_app=WebAppInfo(url="https://keyvan19851363.github.io/web-interface-bot/"),
            )
        ),
    )
